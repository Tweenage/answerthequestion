...
export const batch3EnglishQuestions: Question[] = [
...

  {
    ...
    options: [
      ...
      { text: 'Winter is a difficult time for all forest animals.', isEliminatable: true, eliminationReason: 'The passage only talks about squirrels, not "all forest animals." A rusher picks something that sounds right but adds information not in the passage.' },
      ...
      { text: 'Forests are full of nuts, seeds, and berries in autumn.', isEliminatable: true, eliminationReason: 'The passage is about what squirrels do, not about forests. A rusher picks a statement that sounds related but misses the main point.' },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Parents and teachers organised a fun day for children.', isEliminatable: true, eliminationReason: 'This misses the key point — the fair was to raise money for playground equipment. A rusher picks something that sounds nice but misses the purpose.' },
...

  {
    ...
    options: [
      ...
      { text: 'Life was very hard for everyone in Victorian times.', isEliminatable: true, eliminationReason: 'The passage is specifically about children working, not about everyone. A rusher picks a broad statement that goes beyond what the passage says.' },
    ],
    correctOptionIndex: 1,
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Scientists are worried about climate change around the world.', isEliminatable: true, eliminationReason: 'The passage is specifically about the Amazon rainforest, not climate change in general. A rusher picks something too broad.' },
      { text: 'The Amazon produces twenty per cent of the world\'s oxygen and should be protected.', isEliminatable: true, eliminationReason: 'The passage never says it "should be protected" — that is an opinion not stated. A rusher adds their own conclusion instead of summarising what is written.' },
    ],
    correctOptionIndex: 2,
...

  {
    ...
    correctOptionIndex: 2,
    explanation: 'The writer argues that the printing press had a greater impact than the wheel because it made books cheap and spread knowledge. A rusher might pick "the wheel is the most important invention" without noticing the word "although," which signals the writer disagrees with that view.',
    category: 'summarising',
    trickType: 'position-trap',
  },
  {
    ...
    options: [
      ...
      { text: 'Experts have agreed that homework should be reduced in primary schools.', isEliminatable: true, eliminationReason: 'The passage says there is "no clear agreement among experts." This directly contradicts the text. A rusher jumps to a conclusion not supported by the passage.' },
    ],
    correctOptionIndex: 2,
...

  {
    ...
    options: [
      ...
      { text: 'The test paper got wet and the ink started to run.', isEliminatable: true, eliminationReason: 'There is no mention of water or wet paper. A rusher connects "swam" to water instead of understanding the figurative meaning.' },
    ],
    correctOptionIndex: 2,
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Silver is more valuable than gold.', isEliminatable: true, eliminationReason: 'The passage says nothing about the value of silver. A rusher latches onto the word "silver" without understanding the idiom.' },
      { text: 'Gran prefers sunny weather to rainy weather.', isEliminatable: true, eliminationReason: 'While Gran may enjoy the sun, the saying is about a general life lesson, not a weather preference. A rusher confuses the context with the meaning.' },
    ],
    correctOptionIndex: 1,
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'It tells us that Tom is lost and looking for somewhere to stay.', isEliminatable: true, eliminationReason: 'The passage does not say Tom is lost. A rusher invents details that are not in the text.' },
...

  {
    ...
    options: [
      ...
      { text: 'Amir fell over during the race because his legs gave way.', isEliminatable: true, eliminationReason: 'The passage says he "pushed on," meaning he kept going. A rusher assumes the worst outcome instead of reading what actually happened.' },
    ],
    correctOptionIndex: 3,
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'He had been looking for something in a tree near the car.', isEliminatable: true, eliminationReason: 'There is no actual tree involved. A rusher takes the idiom literally and imagines Dad near a tree.' },
      ...
      { text: 'He thinks the car is too old and should be replaced with a new one.', isEliminatable: true, eliminationReason: 'The passage says Dad went to fetch a new battery, not a new car. A rusher misreads what "a new one" refers to.' },
    ],
    correctOptionIndex: 1,
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'The trees fell down completely and blocked the streets.', isEliminatable: true, eliminationReason: 'The trees "bowed low" — they bent, they did not fall. A rusher exaggerates what happened instead of reading the precise words used.' },
      { text: 'The storm was not very strong and the trees barely moved.', isEliminatable: true, eliminationReason: 'The passage describes howling wind, rattling windows, and torn tiles — this was a powerful storm. A rusher ignores the surrounding context.' },
      { text: 'The villagers had planted the trees at an angle so they already leaned over.', isEliminatable: true, eliminationReason: 'The passage gives no information about how the trees were planted. A rusher invents a reason not found in the text.' },
    ],
    correctOptionIndex: 1,
...

  {
    ...
    options: [
      ...
      { text: 'It shows that the children are misbehaving and Mrs Palmer is angry.', isEliminatable: true, eliminationReason: 'Mrs Palmer has a "calm smile" and does not need to raise her voice. She is not angry. A rusher assumes busy means badly behaved.' },
      { text: 'It compares Mrs Palmer to a queen because she wears a crown.', isEliminatable: true, eliminationReason: 'Mrs Palmer is called "queen of her domain" as a metaphor for being in charge, not because she wears a crown. A rusher takes the comparison literally.' },
    ],
    correctOptionIndex: 2,
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Kai has a heart condition that makes his chest pound.', isEliminatable: true, eliminationReason: '"His heart was a drum" is a metaphor for nervousness, not a medical condition. A rusher takes the description literally.' },
      { text: 'Kai was so frightened that he could not give his speech.', isEliminatable: true, eliminationReason: 'The passage clearly states Kai stepped forward and spoke well. His fear "melted away." A rusher stops reading after the nervous part.' },
      { text: 'The passage is mainly about how bright and hot the spotlight was.', isEliminatable: true, eliminationReason: 'The spotlight is mentioned briefly as a simile. The passage is about Kai\'s feelings, not the stage lighting. A rusher focuses on one detail instead of the main message.' },
    ],
    correctOptionIndex: 1,
