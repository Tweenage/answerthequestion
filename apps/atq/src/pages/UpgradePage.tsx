...
import { useCurrentUser, useAuthStore } from '@atq/shared';
      ...
      >
        ...
        <div className="text-center mb-5">
          <div className="flex items-center justify-center gap-2 mb-1">
            ...
            <span className="font-display font-extrabold text-3xl text-gray-800">£49.99</span>
          </div>
        ...
        >
          {loading ? 'Redirecting to checkout…' : `Unlock Full Access — £${includeCribSheet ? '54.98' : '49.99'} 🔓`}
        </motion.button>
