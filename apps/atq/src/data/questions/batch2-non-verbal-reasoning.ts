...
export const batch2NonVerbalReasoningQuestions: Question[] = [
...

  {
    ...
    options: [
      ...
      { text: '17', isEliminatable: true, eliminationReason: '17 adds 6 to 11. It\'s easy to double the gap of 3, but the pattern consistently adds just 3.' },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: '8', isEliminatable: true, eliminationReason: '8 is diamond + heart (2+6) but forgets the star. Take care — only adds two shapes.' },
      { text: '14', isEliminatable: true, eliminationReason: '14 could come from adding a shape twice.' },
      { text: '6', isEliminatable: true, eliminationReason: '6 is just the heart value alone. It\'s easy to pick the first shape mentioned without adding all three.' },
    ],
