...
export const verbalReasoningQuestions: Question[] = [
  ...
  // vr-1-01: logical-chain
  {
    id: 'vr-1-01',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'If all Bloops are Gleeps, and all Gleeps are Flonks, what must be true about Bloops?',
    questionTokens: [
      'If', 'all', 'Bloops', 'are', 'Gleeps,', 'and', 'all', 'Gleeps', 'are', 'Flonks,',
      'what', 'must', 'be', 'true', 'about', 'Bloops?',
    ],
    keyWordIndices: [1, 2, 3, 4, 6, 7, 8, 9, 11, 13, 15],
    options: [
      { text: 'All Bloops are Flonks', isEliminatable: false },
      { text: 'All Flonks are Bloops', isEliminatable: true, eliminationReason: 'The chain goes Bloops -> Gleeps -> Flonks, not the other way around. Not all Flonks need to be Bloops.' },
      { text: 'No Bloops are Flonks', isEliminatable: true, eliminationReason: 'Since all Bloops are Gleeps and all Gleeps are Flonks, every Bloop must also be a Flonk.' },
      { text: 'Some Bloops are not Gleeps', isEliminatable: true, eliminationReason: 'The passage says ALL Bloops are Gleeps, not just some. This contradicts the first statement.' },
      { text: 'Flonks are Gleeps', isEliminatable: true, eliminationReason: 'The chain says Gleeps are Flonks, not that Flonks are Gleeps. The logic only flows one direction.' },
    ],
    correctOptionIndex: 0,
    explanation: 'This is a logical chain: Bloops -> Gleeps -> Flonks. Step 1: all Bloops are Gleeps. Step 2: all Gleeps are Flonks. So all Bloops must also be Flonks. The chain does NOT work backwards, so we cannot say all Flonks are Bloops.',
    category: 'logic-chain',
    trickType: 'two-step',
  },

  // vr-1-02: analogy-completion
  {
    id: 'vr-1-02',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'Hot is to cold as tall is to ___. Light is to dark as fast is to ___. Which pair correctly completes BOTH sentences?',
    questionTokens: [
      'Hot', 'is', 'to', 'cold', 'as', 'tall', 'is', 'to', '___.', 'Light', 'is', 'to',
      'dark', 'as', 'fast', 'is', 'to', '___.', 'Which', 'pair', 'correctly', 'completes',
      'BOTH', 'sentences?',
    ],
    keyWordIndices: [0, 3, 4, 5, 8, 9, 12, 13, 14, 17, 22],
    options: [
      { text: 'short and slow', isEliminatable: false },
      { text: 'big and slow', isEliminatable: true, eliminationReason: 'Big is not the opposite of tall. The pattern uses opposites: hot/cold, light/dark. The opposite of tall is short.' },
      { text: 'short and quick', isEliminatable: true, eliminationReason: 'Short is correct for the first blank, but quick means the same as fast, not the opposite. The pattern requires opposites.' },
      { text: 'small and heavy', isEliminatable: true, eliminationReason: 'Small is not the opposite of tall (short is), and heavy is not the opposite of fast (slow is).' },
      { text: 'thin and slow', isEliminatable: true, eliminationReason: 'Thin is not the opposite of tall. The pattern is about direct opposites: tall/short, fast/slow.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: spot the pattern -- each pair uses opposites (hot/cold, light/dark). Step 2: apply to both blanks. The opposite of tall is short. The opposite of fast is slow. So the answer is "short and slow". You must check BOTH blanks match the opposite pattern.',
    category: 'analogy',
    trickType: 'two-step',
  },
  ...
  // vr-1-03: comprehension-where
  {
    ...
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'After PE, Lily took off her coat and left it in the school gym. She did not notice until she got home. Where did Lily leave her coat?',
    questionTokens: [
      'After', 'PE,', 'Lily', 'took', 'off', 'her', 'coat', 'and', 'left', 'it', 'in',
      'the', 'school', 'gym.', 'She', 'did', 'not', 'notice', 'until', 'she', 'got',
      'home.', 'Where', 'did', 'Lily', 'leave', 'her', 'coat?',
    ],
    keyWordIndices: [0, 1, 4, 5, 6, 8, 11, 12, 13, 16, 19, 20, 21, 25],
    options: [
      { text: 'The school gym', isEliminatable: false },
      { text: 'At home', isEliminatable: true, eliminationReason: 'Lily got home but that is where she noticed the coat was missing — she did not leave it there. It\'s tempting to pick the last place mentioned.' },
      { text: 'The school playground', isEliminatable: true, eliminationReason: 'The playground is not mentioned. Lily left her coat in the gym after PE.' },
      { text: 'The school canteen', isEliminatable: true, eliminationReason: 'The canteen is not mentioned in the passage. The coat was left in the gym.' },
      { text: 'In the car', isEliminatable: true, eliminationReason: 'No car is mentioned. Lily left her coat in the school gym after PE.' },
    ],
    correctOptionIndex: 0,
    explanation: 'The passage says Lily left her coat "in the school gym" after PE. Home is where she noticed it was missing — not where she left it. It\'s tempting to pick home because it is the last place mentioned.',
    category: 'comprehension-where',
    trickType: 'position-trap',
  },

  // vr-1-04: cipher-pattern
  {
    id: 'vr-1-04',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'In a secret code, each letter is replaced by the one TWO places after it in the alphabet. So A becomes C, and B becomes D. If the coded message is "ECN", what is the original word?',
    questionTokens: [
      'In', 'a', 'secret', 'code,', 'each', 'letter', 'is', 'replaced', 'by', 'the', 'one',
      'TWO', 'places', 'after', 'it', 'in', 'the', 'alphabet.', 'So', 'A', 'becomes', 'C,',
      'and', 'B', 'becomes', 'D.', 'If', 'the', 'coded', 'message', 'is', '"ECN",', 'what',
      'is', 'the', 'original', 'word?',
    ],
    keyWordIndices: [3, 4, 5, 7, 11, 12, 13, 28, 29, 31, 35, 36],
    options: [
      { text: 'CAL', isEliminatable: false },
      { text: 'GEP', isEliminatable: true, eliminationReason: 'GEP is what you get if you shift ECN forwards by 2. But ECN is the CODED word, so you need to go backwards to decode it.' },
      { text: 'ECN', isEliminatable: true, eliminationReason: 'ECN is the coded version. The question asks for the original word before coding, so you must shift each letter back.' },
      { text: 'DBM', isEliminatable: true, eliminationReason: 'DBM goes back only 1 place instead of 2. The code shifts by TWO places, so go back 2: E->C, C->A, N->L.' },
      { text: 'DAL', isEliminatable: true, eliminationReason: 'The first letter is wrong. E shifted back 2 is C, not D. Check each letter carefully: E->C, C->A, N->L gives CAL.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: understand the code shifts letters forward by 2. Step 2: to decode, shift BACK by 2. E->C, C->A, N->L. The original word is CAL. The common mistake is shifting forwards instead of backwards.',
    category: 'cipher',
    trickType: 'reverse-logic',
  },

  // vr-1-05: word-relationship
  {
    id: 'vr-1-05',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'Shoe is to foot as glove is to ___. Now apply the same pattern: hat is to ___.',
    questionTokens: [
      'Shoe', 'is', 'to', 'foot', 'as', 'glove', 'is', 'to', '___.', 'Now', 'apply',
      'the', 'same', 'pattern:', 'hat', 'is', 'to', '___.',
    ],
    keyWordIndices: [0, 3, 4, 5, 8, 9, 10, 12, 13, 14, 17],
    options: [
      { text: 'hand, then head', isEliminatable: false },
      { text: 'hand, then foot', isEliminatable: true, eliminationReason: 'Hand is correct for glove, but a hat is worn on your head, not your foot. Apply the rule: the item covers a body part.' },
      { text: 'arm, then head', isEliminatable: true, eliminationReason: 'A glove covers your hand, not your arm. A shoe covers a foot, a glove covers a hand, a hat covers a head.' },
      { text: 'finger, then ear', isEliminatable: true, eliminationReason: 'A glove covers the whole hand, not just a finger. The pattern links clothing to the main body part it covers.' },
      { text: 'foot, then hand', isEliminatable: true, eliminationReason: 'Foot goes with shoe, not glove. This reverses the first pair. A glove goes with hand, and a hat goes with head.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: find the pattern -- each item covers a body part (shoe covers foot). Step 2: glove covers hand. Step 3: apply the same rule -- hat covers head. Both blanks must follow the "item covers body part" pattern.',
    category: 'analogy',
    trickType: 'two-step',
  },
  ...
  // vr-1-06: comprehension-why (requires separating cause from effect)
  {
    ...
    options: [
      ...
      { text: 'His dad drove him', isEliminatable: true, eliminationReason: 'His dad driving was the result of missing the bus, not the cause. It\'s easy to confuse what happened because of the problem with the cause of the problem.' },
      ...
      { text: 'He forgot to set his alarm', isEliminatable: true, eliminationReason: 'He did set his alarm — the problem was that it did not go off. Take care — skips the detail about what went wrong.' },
  ...
  // vr-1-07: inference-from-premises
  {
    id: 'vr-1-07',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'All of Mrs Brown\'s pupils wore trainers on sports day. Jake is in Mrs Brown\'s class. Tom is in Mr Green\'s class. Tom wore boots. What can we say for certain about Jake on sports day?',
    questionTokens: [
      'All', 'of', 'Mrs', "Brown's", 'pupils', 'wore', 'trainers', 'on', 'sports', 'day.',
      'Jake', 'is', 'in', 'Mrs', "Brown's", 'class.', 'Tom', 'is', 'in', 'Mr', "Green's",
      'class.', 'Tom', 'wore', 'boots.', 'What', 'can', 'we', 'say', 'for', 'certain',
      'about', 'Jake', 'on', 'sports', 'day?',
    ],
    keyWordIndices: [0, 2, 3, 4, 5, 6, 10, 11, 14, 15, 25, 28, 30, 32],
    options: [
      { text: 'Jake wore trainers', isEliminatable: false },
      { text: 'Jake wore boots', isEliminatable: true, eliminationReason: 'Tom wore boots, not Jake. Jake is in Mrs Brown\'s class where ALL pupils wore trainers. Do not mix up the two boys.' },
      { text: 'Jake wore sandals', isEliminatable: true, eliminationReason: 'The passage says ALL of Mrs Brown\'s pupils wore trainers. Jake is in her class, so he wore trainers, not sandals.' },
      { text: 'We cannot tell what Jake wore', isEliminatable: true, eliminationReason: 'We CAN tell: all Mrs Brown\'s pupils wore trainers, and Jake is in her class. So Jake definitely wore trainers.' },
      { text: 'Jake was not at school', isEliminatable: true, eliminationReason: 'Nothing suggests Jake was absent. The passage says all Mrs Brown\'s pupils wore trainers on sports day, which includes Jake.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: all Mrs Brown\'s pupils wore trainers. Step 2: Jake is in Mrs Brown\'s class, so Jake wore trainers. The detail about Tom wearing boots is about a different class and is there to distract you.',
    category: 'logic-deduction',
    trickType: 'irrelevant-info',
  },

  // vr-1-08: sequence-with-two-rules
  {
    id: 'vr-1-08',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'In a letter code, the odd-numbered letters go forwards by 1 and the even-numbered letters go backwards by 1. Starting with BDGK, what are the first two coded letters?',
    questionTokens: [
      'In', 'a', 'letter', 'code,', 'the', 'odd-numbered', 'letters', 'go', 'forwards', 'by',
      '1', 'and', 'the', 'even-numbered', 'letters', 'go', 'backwards', 'by', '1.', 'Starting',
      'with', 'BDGK,', 'what', 'are', 'the', 'first', 'two', 'coded', 'letters?',
    ],
    keyWordIndices: [3, 5, 6, 8, 10, 13, 14, 16, 18, 21, 25, 26, 27, 28],
    options: [
      { text: 'C and C', isEliminatable: false },
      { text: 'C and E', isEliminatable: true, eliminationReason: 'C is correct for B (1st letter, odd, so forward: B->C). But D is the 2nd letter (even), so it goes backwards: D->C, not D->E.' },
      { text: 'A and C', isEliminatable: true, eliminationReason: 'A would mean B went backwards, but B is the 1st letter (odd position), so it goes forwards to C, not backwards to A.' },
      { text: 'A and E', isEliminatable: true, eliminationReason: 'Both letters are wrong. The 1st letter (odd) goes forward: B->C. The 2nd letter (even) goes backward: D->C.' },
      { text: 'C and D', isEliminatable: true, eliminationReason: 'D is unchanged from the original. The 2nd letter (even) must go backwards by 1: D->C, not stay as D.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: B is letter 1 (odd position), so it goes forward by 1: B->C. Step 2: D is letter 2 (even position), so it goes backward by 1: D->C. The first two coded letters are C and C. You must track both the letter position (odd/even) and the direction (forward/backward).',
    category: 'cipher',
    trickType: 'two-step',
  },
  ...
  // vr-1-09: comprehension-when (requires following a chain of information)
  {
    ...
    options: [
      ...
      { text: 'Tuesday', isEliminatable: true, eliminationReason: 'Tuesday is the day after Monday — that is when Mia has swimming, not piano. Take care — stops too early in the chain.' },
      { text: 'Wednesday', isEliminatable: true, eliminationReason: 'Wednesday is only one day after swimming (Tuesday). Piano is TWO days after swimming. Take care — miscounts the days.' },
      { text: 'Friday', isEliminatable: true, eliminationReason: 'Friday is when Mia has dance, not piano. It\'s tempting to pick the wrong activity\'s day.' },
  ...
  // vr-1-11: position-trap
  {
    ...
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'If every Zim is a Wob, and no Wob is a Plink, can a Zim be a Plink?',
    questionTokens: [
      'If', 'every', 'Zim', 'is', 'a', 'Wob,', 'and', 'no', 'Wob', 'is', 'a', 'Plink,',
      'can', 'a', 'Zim', 'be', 'a', 'Plink?',
    ],
    keyWordIndices: [1, 2, 3, 5, 7, 8, 9, 11, 12, 14, 15, 17],
    options: [
      { text: 'No, because every Zim is a Wob and no Wob is a Plink', isEliminatable: false },
      { text: 'Yes, because Zims and Plinks are different things', isEliminatable: true, eliminationReason: 'Being different things does not mean a Zim could be a Plink. Every Zim IS a Wob, and no Wob can be a Plink, so no Zim can be a Plink either.' },
      { text: 'Sometimes, if the Zim is special', isEliminatable: true, eliminationReason: 'The rule says EVERY Zim is a Wob and NO Wob is a Plink. There are no exceptions -- the words "every" and "no" are absolute.' },
      { text: 'We cannot tell from the clues', isEliminatable: true, eliminationReason: 'We CAN tell. The two-step chain (Zim->Wob, and no Wob is Plink) proves no Zim can be a Plink.' },
      { text: 'Only if it stops being a Wob first', isEliminatable: true, eliminationReason: 'The rule says every Zim IS a Wob -- it cannot stop being one. So a Zim is always a Wob and therefore never a Plink.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: every Zim is a Wob. Step 2: no Wob is a Plink. Therefore no Zim can be a Plink, because being a Zim makes you a Wob, and no Wob can be a Plink. Follow the chain of logic!',
    category: 'logic-chain',
    trickType: 'two-step',
  },
  ...
  // vr-1-12: logical-chain
  {
    id: 'vr-1-12',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'Anna is taller than Ben. Ben is taller than Cara. Cara is taller than Dan. Nobody else is involved. Who is the second tallest?',
    questionTokens: [
      'Anna', 'is', 'taller', 'than', 'Ben.', 'Ben', 'is', 'taller', 'than', 'Cara.',
      'Cara', 'is', 'taller', 'than', 'Dan.', 'Nobody', 'else', 'is', 'involved.',
      'Who', 'is', 'the', 'second', 'tallest?',
    ],
    keyWordIndices: [0, 2, 4, 5, 7, 9, 10, 12, 14, 19, 22, 23],
    options: [
      { text: 'Ben', isEliminatable: false },
      { text: 'Anna', isEliminatable: true, eliminationReason: 'Anna is the tallest, not the second tallest. The order is Anna > Ben > Cara > Dan.' },
      { text: 'Cara', isEliminatable: true, eliminationReason: 'Cara is third in the chain: Anna > Ben > Cara > Dan. The question asks for second.' },
      { text: 'Dan', isEliminatable: true, eliminationReason: 'Dan is the shortest. Anna > Ben > Cara > Dan. Second tallest is Ben.' },
      { text: 'We cannot tell', isEliminatable: true, eliminationReason: 'We CAN tell. Build the full chain: Anna > Ben > Cara > Dan. Ben is clearly second.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Build the chain step by step: Anna > Ben, Ben > Cara, Cara > Dan. Full order: Anna, Ben, Cara, Dan. The second tallest is Ben. You must follow all three clues to build the complete ranking.',
    category: 'logic-chain',
    trickType: 'two-step',
  },

  // vr-1-13: word-relationship-pattern
  {
    id: 'vr-1-13',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'Dog is to puppy as cat is to kitten. Following this same pattern, cow is to calf. What pattern connects these pairs?',
    questionTokens: [
      'Dog', 'is', 'to', 'puppy', 'as', 'cat', 'is', 'to', 'kitten.', 'Following', 'this',
      'same', 'pattern,', 'cow', 'is', 'to', 'calf.', 'What', 'pattern', 'connects',
      'these', 'pairs?',
    ],
    keyWordIndices: [0, 3, 4, 5, 8, 9, 11, 12, 13, 16, 17, 18, 19, 21],
    options: [
      { text: 'Adult animal to its young', isEliminatable: false },
      { text: 'Big animal to small animal', isEliminatable: true, eliminationReason: 'The pattern is not about size. A puppy will grow big too. The link is that each pair shows an adult animal and its specific baby name.' },
      { text: 'Male animal to female animal', isEliminatable: true, eliminationReason: 'Puppy and kitten are not female names for animals. They are the names for young animals of that species.' },
      { text: 'Pet to wild animal', isEliminatable: true, eliminationReason: 'Puppy and kitten are still pets, not wild. And cow/calf are farm animals. The link is adult to young.' },
      { text: 'They all rhyme', isEliminatable: true, eliminationReason: 'Dog and puppy do not rhyme, nor do cat and kitten. The pattern is about the relationship in meaning, not sound.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: spot what dog/puppy and cat/kitten have in common -- each is an adult animal paired with its baby. Step 2: confirm with cow/calf -- a calf is a baby cow. The pattern is "adult animal to its young".',
    category: 'analogy',
    trickType: 'context-clue',
  },

  // vr-1-14: multi-premise-inference
  {
    id: 'vr-1-14',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'Ella always wears red on Mondays. Today is not Monday. Ella is wearing blue. Which of these must be true?',
    questionTokens: [
      'Ella', 'always', 'wears', 'red', 'on', 'Mondays.', 'Today', 'is', 'not', 'Monday.',
      'Ella', 'is', 'wearing', 'blue.', 'Which', 'of', 'these', 'must', 'be', 'true?',
    ],
    keyWordIndices: [1, 2, 3, 5, 6, 8, 9, 10, 12, 13, 17, 19],
    options: [
      { text: 'Ella does not always wear red', isEliminatable: true, eliminationReason: 'Ella DOES always wear red on Mondays. Today is not Monday, which is why she is wearing blue. The rule still holds.' },
      { text: 'Ella never wears blue', isEliminatable: true, eliminationReason: 'Ella IS wearing blue right now. The rule only says she wears red on Mondays -- she can wear other colours on other days.' },
      { text: 'Today is not Monday and Ella can wear other colours on other days', isEliminatable: false },
      { text: 'Ella has broken her own rule', isEliminatable: true, eliminationReason: 'Ella has not broken her rule. She wears red on Mondays. Today is NOT Monday, so wearing blue is perfectly fine.' },
      { text: 'It must be Sunday', isEliminatable: true, eliminationReason: 'We only know it is NOT Monday. It could be any other day of the week -- we cannot be certain it is Sunday.' },
    ],
    correctOptionIndex: 2,
    explanation: 'Step 1: Ella wears red on Mondays (the rule). Step 2: today is not Monday (given). Step 3: so Ella is free to wear other colours. Wearing blue today does not break her Monday rule. You need to combine the rule with the specific day to reach the conclusion.',
    category: 'logic-deduction',
    trickType: 'context-clue',
  },

  // vr-1-15: negation-chain
  {
    id: 'vr-1-15',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'Sam does not like apples. He only eats fruit that is not red. Bananas are yellow. Strawberries are red. Which fruit would Sam eat?',
    questionTokens: [
      'Sam', 'does', 'not', 'like', 'apples.', 'He', 'only', 'eats', 'fruit', 'that', 'is',
      'not', 'red.', 'Bananas', 'are', 'yellow.', 'Strawberries', 'are', 'red.', 'Which',
      'fruit', 'would', 'Sam', 'eat?',
    ],
    keyWordIndices: [2, 4, 6, 7, 8, 11, 12, 13, 15, 16, 18, 19, 20, 22, 23],
    options: [
      { text: 'A banana', isEliminatable: false },
      { text: 'A strawberry', isEliminatable: true, eliminationReason: 'Strawberries are red, and Sam only eats fruit that is NOT red. A strawberry fails the colour rule.' },
      { text: 'An apple', isEliminatable: true, eliminationReason: 'Sam does not like apples. Even ignoring the colour rule, apples are specifically ruled out.' },
      { text: 'A red grape', isEliminatable: true, eliminationReason: 'A red grape is red, and Sam only eats fruit that is not red. The colour rule eliminates it.' },
      { text: 'None of them', isEliminatable: true, eliminationReason: 'A banana is yellow (not red) and is not an apple, so it passes both of Sam\'s rules.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: rule out apples (Sam does not like them). Step 2: rule out any red fruit (strawberries, red grapes). Bananas are yellow (not red) and are not apples, so they pass both rules.',
    category: 'logic-deduction',
    trickType: 'negation-trap',
  },

  // vr-1-16: logical-chain-with-negation
  {
    id: 'vr-1-16',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'Every child who finishes their homework gets a gold star. Mia finished her homework. Josh did not finish his homework. Mia also tidied her desk, but that does not earn a star. Who definitely gets a gold star?',
    questionTokens: [
      'Every', 'child', 'who', 'finishes', 'their', 'homework', 'gets', 'a', 'gold', 'star.',
      'Mia', 'finished', 'her', 'homework.', 'Josh', 'did', 'not', 'finish', 'his', 'homework.',
      'Mia', 'also', 'tidied', 'her', 'desk,', 'but', 'that', 'does', 'not', 'earn', 'a', 'star.',
      'Who', 'definitely', 'gets', 'a', 'gold', 'star?',
    ],
    keyWordIndices: [0, 1, 3, 5, 6, 8, 9, 10, 11, 13, 14, 16, 17, 32, 33, 34, 36, 37],
    options: [
      { text: 'Mia', isEliminatable: false },
      { text: 'Josh', isEliminatable: true, eliminationReason: 'Josh did NOT finish his homework. The rule says you must finish homework to get a star, so Josh does not qualify.' },
      { text: 'Both Mia and Josh', isEliminatable: true, eliminationReason: 'Josh did not finish his homework, so he does not get a star. Only Mia finished and earns one.' },
      { text: 'Neither of them', isEliminatable: true, eliminationReason: 'Mia finished her homework, so she definitely gets a star. The rule guarantees it.' },
      { text: 'Mia gets two stars', isEliminatable: true, eliminationReason: 'Tidying the desk does NOT earn a star. Stars are only for finishing homework. Mia gets one star.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: the rule is "finish homework = gold star." Step 2: Mia finished, so she gets a star. Josh did not finish, so he does not. The desk tidying is irrelevant -- it does not earn stars.',
    category: 'logic-deduction',
    trickType: 'irrelevant-info',
  },

  // vr-1-17: exception-as-rule
  {
    id: 'vr-1-17',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'All of the sweets in the jar are round, except the toffees which are square. Liam picks a sweet at random and it is square. What must Liam have picked?',
    questionTokens: [
      'All', 'of', 'the', 'sweets', 'in', 'the', 'jar', 'are', 'round,', 'except', 'the',
      'toffees', 'which', 'are', 'square.', 'Liam', 'picks', 'a', 'sweet', 'at', 'random',
      'and', 'it', 'is', 'square.', 'What', 'must', 'Liam', 'have', 'picked?',
    ],
    keyWordIndices: [0, 3, 7, 8, 9, 11, 13, 14, 15, 16, 22, 23, 24, 26, 29],
    options: [
      { text: 'A toffee', isEliminatable: false },
      { text: 'A round sweet', isEliminatable: true, eliminationReason: 'Liam\'s sweet is square, not round. Round sweets are every type EXCEPT toffees, and his sweet is square.' },
      { text: 'Any sweet at all', isEliminatable: true, eliminationReason: 'Not just any sweet -- only toffees are square. Since his sweet is square, it must specifically be a toffee.' },
      { text: 'A jelly baby', isEliminatable: true, eliminationReason: 'A jelly baby is not mentioned. The passage only tells us about round sweets and square toffees.' },
      { text: 'We cannot tell', isEliminatable: true, eliminationReason: 'We CAN tell. Only toffees are square. His sweet is square. So it must be a toffee.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: all sweets are round EXCEPT toffees. Step 2: toffees are square. Step 3: Liam\'s sweet is square, so it must be a toffee. The exception to the rule is the key clue.',
    category: 'logic-deduction',
    trickType: 'exception-as-rule',
  },

  // vr-1-18: cipher-decode
  {
    id: 'vr-1-18',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'In a code, the number 1 means "big", the number 2 means "red", and the number 3 means "dog". What does "2 1 3" mean?',
    questionTokens: [
      'In', 'a', 'code,', 'the', 'number', '1', 'means', '"big",', 'the', 'number', '2',
      'means', '"red",', 'and', 'the', 'number', '3', 'means', '"dog".', 'What', 'does',
      '"2', '1', '3"', 'mean?',
    ],
    keyWordIndices: [2, 5, 6, 7, 10, 11, 12, 16, 17, 18, 19, 21, 22, 23, 24],
    options: [
      { text: 'red big dog', isEliminatable: false },
      { text: 'big red dog', isEliminatable: true, eliminationReason: 'This puts the words in a natural English order, but the code says 2-1-3, which is red-big-dog. You must follow the code order, not rearrange to sound nice.' },
      { text: 'dog red big', isEliminatable: true, eliminationReason: 'This reverses the code: 3-2-1. The coded message is 2-1-3, so the order must be red-big-dog.' },
      { text: 'big dog red', isEliminatable: true, eliminationReason: 'This would be 1-3-2, not 2-1-3. Decode each number in the order it appears: 2=red, 1=big, 3=dog.' },
      { text: 'red dog big', isEliminatable: true, eliminationReason: 'This would be 2-3-1, not 2-1-3. The middle number is 1 (big), not 3 (dog). Keep the coded order.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: decode each number using the key (1=big, 2=red, 3=dog). Step 2: keep them in the ORDER given: 2=red, 1=big, 3=dog. The answer is "red big dog". The trap is rearranging the words to sound like normal English instead of following the code order.',
    category: 'cipher',
    trickType: 'position-trap',
  },

  // vr-1-19: reverse-logic
  {
    id: 'vr-1-19',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'In a group of animals, every animal with spots can swim. Daisy has spots. Rex has stripes. Which statement must be FALSE?',
    questionTokens: [
      'In', 'a', 'group', 'of', 'animals,', 'every', 'animal', 'with', 'spots', 'can', 'swim.',
      'Daisy', 'has', 'spots.', 'Rex', 'has', 'stripes.', 'Which', 'statement', 'must', 'be', 'FALSE?',
    ],
    keyWordIndices: [5, 6, 8, 9, 10, 11, 12, 13, 14, 16, 17, 18, 19, 21],
    options: [
      { text: 'Daisy cannot swim', isEliminatable: false },
      { text: 'Rex can swim', isEliminatable: true, eliminationReason: 'We do not know if Rex can swim. The rule only tells us about spotted animals. Rex has stripes, so the rule does not apply to him. This MIGHT be true.' },
      { text: 'Daisy can swim', isEliminatable: true, eliminationReason: 'This is TRUE, not false. Daisy has spots and every spotted animal can swim, so Daisy can swim.' },
      { text: 'Rex has stripes', isEliminatable: true, eliminationReason: 'This is TRUE -- the passage directly states Rex has stripes.' },
      { text: 'Daisy has spots', isEliminatable: true, eliminationReason: 'This is TRUE -- the passage directly states Daisy has spots.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: every spotted animal can swim. Step 2: Daisy has spots, so Daisy CAN swim. Step 3: therefore "Daisy cannot swim" must be FALSE. The question asks for the false statement -- you need to identify what contradicts the given rules.',
    category: 'logic-deduction',
    trickType: 'reverse-logic',
  },

  // vr-1-20: multi-premise-deduction
  {
    id: 'vr-1-20',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'Three children are in a queue. Kai is not first. The person in first place has brown hair. Ava has blonde hair and is second. Kai has brown hair. Who is first in the queue?',
    questionTokens: [
      'Three', 'children', 'are', 'in', 'a', 'queue.', 'Kai', 'is', 'not', 'first.',
      'The', 'person', 'in', 'first', 'place', 'has', 'brown', 'hair.', 'Ava', 'has',
      'blonde', 'hair', 'and', 'is', 'second.', 'Kai', 'has', 'brown', 'hair.',
      'Who', 'is', 'first', 'in', 'the', 'queue?',
    ],
    keyWordIndices: [6, 8, 9, 11, 13, 14, 15, 16, 17, 18, 20, 24, 25, 27, 28, 29, 31, 34],
    options: [
      { text: 'Kai', isEliminatable: true, eliminationReason: 'The passage says Kai is NOT first. Even though Kai has brown hair, the "not first" clue rules Kai out.' },
      { text: 'Ava', isEliminatable: true, eliminationReason: 'Ava is second in the queue, not first. Also, Ava has blonde hair, and first place needs brown hair.' },
      { text: 'The third child (not named)', isEliminatable: false },
      { text: 'Nobody has brown hair', isEliminatable: true, eliminationReason: 'Kai has brown hair, and the unnamed third child could too. The passage tells us first place HAS brown hair.' },
      { text: 'We cannot work it out', isEliminatable: true, eliminationReason: 'We CAN: Kai is not first, Ava is second. The third child must be first, and they must have brown hair.' },
    ],
    correctOptionIndex: 2,
    explanation: 'Step 1: Ava is second (given). Step 2: Kai is not first (given). Step 3: the only person left for first place is the unnamed third child. This child must have brown hair (the rule for first place). You must combine all the clues.',
    category: 'logic-deduction',
    trickType: 'two-step',
  },

  // vr-1-21: analogy-pattern
  {
    id: 'vr-1-21',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'Painter is to brush as writer is to pen. Following the same pattern, chef is to ___.',
    questionTokens: [
      'Painter', 'is', 'to', 'brush', 'as', 'writer', 'is', 'to', 'pen.', 'Following',
      'the', 'same', 'pattern,', 'chef', 'is', 'to', '___.',
    ],
    keyWordIndices: [0, 3, 4, 5, 8, 9, 11, 12, 13, 16],
    options: [
      { text: 'knife', isEliminatable: false },
      { text: 'food', isEliminatable: true, eliminationReason: 'Food is what a chef makes, not the tool they use. The pattern links a person to their main TOOL: painter/brush, writer/pen.' },
      { text: 'restaurant', isEliminatable: true, eliminationReason: 'A restaurant is where a chef works, not the tool they use. The pattern is person to tool, not person to workplace.' },
      { text: 'hat', isEliminatable: true, eliminationReason: 'A hat is what a chef wears, not the tool they use. The pattern links a person to their working tool.' },
      { text: 'recipe', isEliminatable: true, eliminationReason: 'A recipe is instructions a chef follows, not their main tool. The pattern is person to their key tool: brush, pen, knife.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: find the pattern -- a painter uses a brush, a writer uses a pen. The link is "person to their main tool". Step 2: apply it -- a chef uses a knife. The trap is picking something related to chefs (food, restaurant) that does not match the tool pattern.',
    category: 'analogy',
    trickType: 'context-clue',
  },
  ...
  // vr-1-23: logical-chain
  {
    id: 'vr-1-23',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'If it rains, the match is cancelled. If the match is cancelled, the team goes to the gym instead. It is raining. Where does the team go?',
    questionTokens: [
      'If', 'it', 'rains,', 'the', 'match', 'is', 'cancelled.', 'If', 'the', 'match',
      'is', 'cancelled,', 'the', 'team', 'goes', 'to', 'the', 'gym', 'instead.',
      'It', 'is', 'raining.', 'Where', 'does', 'the', 'team', 'go?',
    ],
    keyWordIndices: [0, 2, 4, 6, 7, 9, 11, 13, 14, 17, 18, 19, 21, 22, 25, 26],
    options: [
      { text: 'To the gym', isEliminatable: false },
      { text: 'To the match', isEliminatable: true, eliminationReason: 'It is raining, so the match is cancelled. They cannot go to a match that has been cancelled.' },
      { text: 'Home', isEliminatable: true, eliminationReason: 'Home is not mentioned. The rule says if the match is cancelled, the team goes to the gym, not home.' },
      { text: 'To the park', isEliminatable: true, eliminationReason: 'A park is not mentioned anywhere. The chain is: rain -> match cancelled -> gym.' },
      { text: 'Nowhere', isEliminatable: true, eliminationReason: 'The rules tell us exactly what happens: rain causes cancellation, cancellation means gym. They go somewhere.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Follow the chain: Step 1 -- it is raining, so the match is cancelled (rule 1). Step 2 -- the match is cancelled, so the team goes to the gym (rule 2). You must connect both rules in sequence.',
    category: 'logic-chain',
    trickType: 'two-step',
  },

  // vr-1-24: code-cipher-pattern
  {
    id: 'vr-1-24',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'In a code, APPLE is written as 1-16-16-12-5 by replacing each letter with its position in the alphabet (A=1, B=2, C=3...). What does the code 3-1-20 spell?',
    questionTokens: [
      'In', 'a', 'code,', 'APPLE', 'is', 'written', 'as', '1-16-16-12-5', 'by', 'replacing',
      'each', 'letter', 'with', 'its', 'position', 'in', 'the', 'alphabet', '(A=1,', 'B=2,',
      'C=3...).', 'What', 'does', 'the', 'code', '3-1-20', 'spell?',
    ],
    keyWordIndices: [2, 3, 7, 9, 10, 11, 14, 17, 18, 19, 20, 21, 24, 25, 26],
    options: [
      { text: 'CAT', isEliminatable: false },
      { text: 'BAT', isEliminatable: true, eliminationReason: 'B is the 2nd letter, not 3rd. The first number is 3, which is C. C-A-T, not B-A-T.' },
      { text: 'CAR', isEliminatable: true, eliminationReason: 'R is the 18th letter, not 20th. The last number is 20, which is T. The word is C-A-T.' },
      { text: 'DAT', isEliminatable: true, eliminationReason: 'D is the 4th letter. The first number is 3, which is C, not D.' },
      { text: 'CUT', isEliminatable: true, eliminationReason: 'U is the 21st letter. The middle number is 1, which is A, not U. The word is C-A-T.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: understand the code (letter position in alphabet). Step 2: decode each number: 3=C, 1=A, 20=T. The word is CAT. You need to know (or count) alphabet positions and decode all three numbers correctly.',
    category: 'cipher',
    trickType: 'two-step',
  },

  // vr-1-25: inference-from-negation
  {
    id: 'vr-1-25',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'Three children each chose a different colour: red, blue, or green. Aisha did not pick red or blue. Ben picked blue. What colour did Aisha pick?',
    questionTokens: [
      'Three', 'children', 'each', 'chose', 'a', 'different', 'colour:', 'red,', 'blue,',
      'or', 'green.', 'Aisha', 'did', 'not', 'pick', 'red', 'or', 'blue.',
      'Ben', 'picked', 'blue.', 'What', 'colour', 'did', 'Aisha', 'pick?',
    ],
    keyWordIndices: [2, 5, 6, 11, 13, 14, 15, 17, 18, 20, 21, 22, 24, 25],
    options: [
      { text: 'Red', isEliminatable: true, eliminationReason: 'Aisha did NOT pick red -- the passage says so directly. The only colour left after ruling out red and blue is green.' },
      { text: 'Blue', isEliminatable: true, eliminationReason: 'Aisha did NOT pick blue -- the passage says so directly. Also, Ben already picked blue.' },
      { text: 'Green', isEliminatable: false },
      { text: 'Yellow', isEliminatable: true, eliminationReason: 'Yellow is not one of the three colours available (red, blue, green). It cannot be the answer.' },
      { text: 'We cannot tell', isEliminatable: true, eliminationReason: 'We CAN tell. Aisha cannot pick red or blue, and the only other option is green. So she must have picked green.' },
    ],
    correctOptionIndex: 2,
    explanation: 'Step 1: Aisha did not pick red. Step 2: Aisha did not pick blue. Step 3: the only remaining colour is green. Elimination of two options leaves exactly one answer.',
    category: 'logic-deduction',
    trickType: 'negation-trap',
  },

  // vr-1-26: exception-as-rule
  {
    id: 'vr-1-26',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'The library is open every day of the week except Wednesday. The swimming pool is open every day except Sunday. Today is Wednesday. Which place is open today?',
    questionTokens: [
      'The', 'library', 'is', 'open', 'every', 'day', 'of', 'the', 'week', 'except',
      'Wednesday.', 'The', 'swimming', 'pool', 'is', 'open', 'every', 'day', 'except',
      'Sunday.', 'Today', 'is', 'Wednesday.', 'Which', 'place', 'is', 'open', 'today?',
    ],
    keyWordIndices: [1, 3, 4, 9, 10, 12, 13, 15, 16, 18, 19, 20, 22, 23, 24, 26, 27],
    options: [
      { text: 'The swimming pool', isEliminatable: false },
      { text: 'The library', isEliminatable: true, eliminationReason: 'The library is closed on Wednesdays. Today is Wednesday, so the library is not open.' },
      { text: 'Both places', isEliminatable: true, eliminationReason: 'The library is closed on Wednesdays. Only the swimming pool is open today.' },
      { text: 'Neither place', isEliminatable: true, eliminationReason: 'The swimming pool is open every day except Sunday. Today is Wednesday, not Sunday, so the pool is open.' },
      { text: 'We cannot tell', isEliminatable: true, eliminationReason: 'We CAN tell. The library is closed on Wednesdays, and the pool is closed on Sundays. Today is Wednesday, so only the pool is open.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: check the library -- it is closed on Wednesdays, and today is Wednesday, so it is closed. Step 2: check the pool -- it is closed on Sundays, but today is Wednesday, so it is open. Only the swimming pool is open today.',
    category: 'logic-deduction',
    trickType: 'exception-as-rule',
  },

  // vr-1-27: reverse-logic-with-negation
  {
    id: 'vr-1-27',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'No child in Class 3 is left-handed. Emma is in Class 3. Tom is in Class 4. Tom is left-handed. What do we know for certain about Emma?',
    questionTokens: [
      'No', 'child', 'in', 'Class', '3', 'is', 'left-handed.', 'Emma', 'is', 'in', 'Class', '3.',
      'Tom', 'is', 'in', 'Class', '4.', 'Tom', 'is', 'left-handed.', 'What', 'do', 'we',
      'know', 'for', 'certain', 'about', 'Emma?',
    ],
    keyWordIndices: [0, 1, 3, 4, 6, 7, 8, 10, 11, 20, 23, 25, 27],
    options: [
      { text: 'Emma is not left-handed', isEliminatable: false },
      { text: 'Emma is left-handed', isEliminatable: true, eliminationReason: 'NO child in Class 3 is left-handed, and Emma is in Class 3. So Emma cannot be left-handed.' },
      { text: 'Emma is in Class 4', isEliminatable: true, eliminationReason: 'The passage says Emma is in Class 3, not Class 4. Tom is the one in Class 4.' },
      { text: 'We cannot tell', isEliminatable: true, eliminationReason: 'We CAN tell. The rule says no one in Class 3 is left-handed. Emma is in Class 3. So Emma is definitely not left-handed.' },
      { text: 'Emma is like Tom', isEliminatable: true, eliminationReason: 'Tom is left-handed and in Class 4. Emma is in Class 3 where no one is left-handed. They are different.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: no child in Class 3 is left-handed (the rule). Step 2: Emma is in Class 3 (given). Therefore Emma is not left-handed. Tom is a red herring -- he is in a different class.',
    category: 'logic-deduction',
    trickType: 'irrelevant-info',
  },
  ...
  // vr-1-29: logical-chain-with-condition
  {
    id: 'vr-1-29',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'If a shape is red, it goes in Box A. If a shape is round, it goes in Box B. If a shape is both red AND round, it goes in Box C instead. Where does a red circle go?',
    questionTokens: [
      'If', 'a', 'shape', 'is', 'red,', 'it', 'goes', 'in', 'Box', 'A.', 'If', 'a', 'shape',
      'is', 'round,', 'it', 'goes', 'in', 'Box', 'B.', 'If', 'a', 'shape', 'is', 'both',
      'red', 'AND', 'round,', 'it', 'goes', 'in', 'Box', 'C', 'instead.', 'Where', 'does',
      'a', 'red', 'circle', 'go?',
    ],
    keyWordIndices: [2, 4, 8, 9, 12, 14, 18, 19, 22, 24, 25, 26, 27, 31, 32, 33, 34, 37, 38, 39],
    options: [
      { text: 'Box C', isEliminatable: false },
      { text: 'Box A', isEliminatable: true, eliminationReason: 'A red circle IS red, so you might think Box A. But it is ALSO round. The "both" rule overrides: red AND round goes to Box C.' },
      { text: 'Box B', isEliminatable: true, eliminationReason: 'A circle IS round, so you might think Box B. But it is ALSO red. The "both" rule overrides: red AND round goes to Box C.' },
      { text: 'Both Box A and Box B', isEliminatable: true, eliminationReason: 'The third rule says shapes that are both red AND round go in Box C INSTEAD. They do not go in two boxes.' },
      { text: 'None of the boxes', isEliminatable: true, eliminationReason: 'A red circle matches the third rule (both red and round), so it definitely goes in Box C.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: a circle is round. Step 2: it is also red. Step 3: the third rule says "both red AND round" goes in Box C instead of A or B. The special "both" rule overrides the individual rules.',
    category: 'logic-deduction',
    trickType: 'exception-as-rule',
  },

  // vr-1-30: inference-from-clues
  {
    id: 'vr-1-30',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'A mystery animal has fur, four legs, and barks. It is not a fox because foxes do not bark. It is not a cat because cats meow. What is the mystery animal most likely to be?',
    questionTokens: [
      'A', 'mystery', 'animal', 'has', 'fur,', 'four', 'legs,', 'and', 'barks.', 'It', 'is',
      'not', 'a', 'fox', 'because', 'foxes', 'do', 'not', 'bark.', 'It', 'is', 'not', 'a',
      'cat', 'because', 'cats', 'meow.', 'What', 'is', 'the', 'mystery', 'animal', 'most',
      'likely', 'to', 'be?',
    ],
    keyWordIndices: [1, 2, 4, 5, 6, 8, 11, 13, 17, 18, 21, 23, 26, 27, 30, 31, 33, 35],
    options: [
      { text: 'A dog', isEliminatable: false },
      { text: 'A fox', isEliminatable: true, eliminationReason: 'The passage says it is NOT a fox because foxes do not bark. This option is directly ruled out.' },
      { text: 'A cat', isEliminatable: true, eliminationReason: 'The passage says it is NOT a cat because cats meow, not bark. This option is directly ruled out.' },
      { text: 'A fish', isEliminatable: true, eliminationReason: 'A fish does not have fur, four legs, or bark. It fails all three clues.' },
      { text: 'A snake', isEliminatable: true, eliminationReason: 'A snake has no legs and no fur. It fails two of the three clues.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: the animal has fur, four legs, and barks. Step 2: eliminate fox (does not bark) and cat (meows). Step 3: a dog has fur, four legs, and barks. Use the clues to eliminate wrong answers and identify the match.',
    category: 'logic-deduction',
    trickType: 'context-clue',
  },

  // vr-1-31: analogy-with-reversal
  {
    id: 'vr-1-31',
    subject: 'reasoning',
    difficulty: 1,
    questionText: 'Day is to night as summer is to winter. Using the same rule, beginning is to ___.',
    questionTokens: [
      'Day', 'is', 'to', 'night', 'as', 'summer', 'is', 'to', 'winter.', 'Using', 'the',
      'same', 'rule,', 'beginning', 'is', 'to', '___.',
    ],
    keyWordIndices: [0, 3, 4, 5, 8, 9, 11, 12, 13, 16],
    options: [
      { text: 'end', isEliminatable: false },
      { text: 'start', isEliminatable: true, eliminationReason: 'Start means the same as beginning. The pattern uses OPPOSITES (day/night, summer/winter), not synonyms.' },
      { text: 'middle', isEliminatable: true, eliminationReason: 'Middle is between beginning and end, but the pattern links exact opposites, not things in between.' },
      { text: 'morning', isEliminatable: true, eliminationReason: 'Morning is related to "day" from the first pair, not an opposite of beginning. Stay focused on the pattern.' },
      { text: 'finish', isEliminatable: true, eliminationReason: 'Finish is close but "end" is the more direct opposite of "beginning." Day/night and summer/winter are clean opposites.' },
    ],
    correctOptionIndex: 0,
    explanation: 'Step 1: spot the pattern -- day and night are opposites, summer and winter are opposites. Step 2: apply the rule -- the opposite of beginning is end. The trap is picking a synonym (start) or a related word (middle) instead of the true opposite.',
    category: 'analogy',
    trickType: 'reverse-logic',
  },
