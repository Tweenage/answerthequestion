...
export const newNonVerbalReasoningQuestions: Question[] = [
...

  {
    ...
    options: [
      { text: '8', isEliminatable: true, eliminationReason: '8 is triangle + square (3 + 5) without adding the circle. Take care — forgets the last item.' },
      ...
      { text: '15', isEliminatable: true, eliminationReason: '15 is 2 + 3 + 5 + 5 — it\'s easy to count the square twice.' },
      { text: '7', isEliminatable: true, eliminationReason: '7 is circle + square (2 + 5) without the triangle. It\'s easy to skip the middle shape in the sum.' },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: '16', isEliminatable: true, eliminationReason: '16 adds 4 instead of 3. It\'s easy to confuse the 4-times table with the 3-times table.' },
    ],
